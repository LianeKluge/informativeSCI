...
```
cd existing_repo
git remote add origin https://gitlab.informatik.uni-bremen.de/liane/informativesciproject.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.informatik.uni-bremen.de/liane/informativesciproject/-/settings/integrations)
